...
public class SecurityConfig {
	...
	/*
	 * THIS IS FOR INMEMORY USAGE
	 * 
	 * @Bean public UserDetailsService userDetailsService() { UserDetails
	 * userDetails = User.builder(). username("user")
	 * .password("$2a$12$o70gtPDHtKgDaUiqWYxCfOOMKFJT9otj.vFufLi81uEg.7lP4Qxla").
	 * roles("USER"). build(); UserDetails adminDetails = User.builder().
	 * username("admin")
	 * .password("$2a$12$o70gtPDHtKgDaUiqWYxCfOOMKFJT9otj.vFufLi81uEg.7lP4Qxla").
	 * roles("ADMIN","USER"). build(); return new
	 * InMemoryUserDetailsManager(userDetails,adminDetails); }
	 */
